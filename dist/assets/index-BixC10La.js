...
function displayLoadMessage(text, loadMessage, clear) {
  if (!loadMessage) {
...
function loadSaveFile(saveFile, loadMessage) {
...
const saveUtils = { loadSaveFile, downloadSaveFile };
let appRoot = document.createElement("div");
document.body.appendChild(appRoot);
const root = createRoot(appRoot);
let loadFileSelectorRef = reactExports.createRef();
let loadButtonRef = reactExports.createRef();
let loadMessageRef = reactExports.createRef();
function loadWrapper() {
  if (loadFileSelectorRef.current)
    saveUtils.loadSaveFile(loadFileSelectorRef.current);
}
let loadFileSelector = /* @__PURE__ */ React.createElement("input", { type: "file", id: "saveFile", ref: loadFileSelectorRef });
let loadButtonEle = /* @__PURE__ */ React.createElement("button", { onClick: loadWrapper, ref: loadButtonRef }, "load");
